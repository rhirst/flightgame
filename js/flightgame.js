...
function ship() {
	...
	obj.image = new Image();
	console.log("ship: " + ship_level);
	obj.image.src = "img/shuttlesprites.png";
	if (ship_level == 0) obj.image.src = "img/shuttlesprites.png";
	else if (ship_level == 1) obj.image.src = "img/shuttlesprites.png";
	else if (ship_level == 2) obj.image.src = "img/shuttlesprites.png";
...
function bullet () {
	...
	var obj = {}; 
	obj.image = new Image();
	obj.image.src = "img/laserblue.png";
	obj.x = player.x + 15;
	obj.y = player.y;
	obj.vy = 10;
	obj.vx = 0;
...
function enemy_bullet(x_cord, y_cord) {
	var obj = {}; 
	obj.image = new Image();
	obj.image.src = "img/laserred.png";
	obj.x = x_cord;
	obj.y = y_cord;
	obj.vy = 10;
	obj.vx = 0;
...
function enemy (type, power) {
	...
	obj.image = new Image();
	if (obj.type == 0){
		obj.image.src = "img/enemyship.png";
		...
		obj.image.src = "img/enemyshipFatty.png";
		obj.vy = Math.random();
	...
	function draw() {
		...
		if (LoseCondition){			
			...
			lose.image.src = "img/Controls.png";    // font in image is 'i_fink_u_freeky' by author Frédéric Rich
